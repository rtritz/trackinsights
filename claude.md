...
│
├── web/
│   ├── app.py                    # Entry point (python app.py, from web/ or the repo root)
...
│   │   │   ├── school_dashboard.py   dashboards + statewide program rankings
...
│   └── frontend/
│       ├── templates/            # Jinja2; insights/ for the insight pages
│       └── static/
