"""
Demo script showing example usage of get_percentiles(). Not a pytest suite --
just runnable, printed examples.

Run from the web/ directory: python -m backend.analytics.examples.demo_percentiles
"""
