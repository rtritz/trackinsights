"""
Demo script for projected team score calculations. Not a pytest suite --
just runnable, asserted examples.

Run from the web/ directory: python -m backend.analytics.examples.demo_projected_team_scores
"""
